...
var Dashboard = (function () {
    function Dashboard(dashboardService, currencyService, errorService) {
    ...
    Dashboard.prototype.ngOnInit = function () {
        var _this = this;
        this.currencyService.getDefaultCurrency().subscribe(function (currency) {
    ...
    Dashboard = __decorate([
        ...
        __metadata('design:paramtypes', [dashboard_service_1.DashboardService, currency_service_1.CurrencyService, error_service_1.ErrorService])
    ], Dashboard);
    return Dashboard;
}());
