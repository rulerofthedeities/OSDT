...
var SignUp = (function () {
    function SignUp(formBuilder, authService, errorService, http) {
    ...
    SignUp.prototype.onSubmitForm = function (user) {
        ...
        if (this.userForm.valid) {
            this.authService.signup(user).subscribe(function (data) {
                _this.authService.signin(user).subscribe(function (data) { return _this.authService.signedIn(data); }, function (error) { return _this.errorService.handleError(error); });
    ...
    SignUp = __decorate([
        ...
        __metadata('design:paramtypes', [forms_1.FormBuilder, auth_service_1.AuthService, error_service_1.ErrorService, http_1.Http])
    ], SignUp);
    return SignUp;
}());
