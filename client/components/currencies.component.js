...
var Currencies = (function () {
    ...
    Currencies.prototype.setDefault = function (currencyCode) {
        ...
        this.settingsService.setDefaultCurrency(currencyCode).subscribe(function (defaultCurrency) { _this.defaultCurrency = defaultCurrency; }, function (error) { return _this.errorService.handleError(error); });
    };
    Currencies = __decorate([
        ...
        __metadata('design:paramtypes', [currency_service_1.CurrencyService, settings_service_1.SettingsService, auth_service_1.AuthService, error_service_1.ErrorService])
    ], Currencies);
    return Currencies;
}());
